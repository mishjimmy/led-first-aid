...
- Service `0xFFD5`, write characteristic `0xFFD9` (write without response when supported). The code passes these as 128-bit strings (`U("ffd5")`, `U("ffd9")`), never as numeric aliases; see Development notes.
